...
import static cn.lunadeer.liteworldedit.utils.Misc.formatString;
import static cn.lunadeer.liteworldedit.utils.XLogger.isDebug;
...
public class Notification {
    ...
    public static void title(Player player, Component title, Component subtitle) {
        instance.sender.sendTitle(player, title, subtitle);
    }
